...
class DocView extends ContentView {
    ...
    updateInner(changes, deco, oldLength, forceSelection = false, pointerSel = false) {
        ...
        this.view.observer.ignore(() => {
            ...
            let track = browser$1.chrome ? { node: getSelection(this.view.root).focusNode, written: false } : undefined;
            this.sync(track);
            this.dirty = 0 /* Not */;
    ...
    updateSelection(force = false, fromPointer = false) {
        ...
        if (force || !domSel.focusNode ||
            (browser$1.gecko && main.empty && nextToUneditable(domSel.focusNode, domSel.focusOffset)) ||
...
class InputState {
    ...
    keydown(view, event) {
        ...
        if (browser$1.ios && (event.keyCode == 13 || event.keyCode == 8) &&
...
class DOMObserver {
    ...
    onSelectionChange(event) {
        ...
        if (browser$1.ie && browser$1.ie_version <= 11 && !view.state.selection.main.empty &&
    ...
    get selectionRange() {
        if (!this._selectionRange) {
            ...
            if (browser$1.safari && root.nodeType == 11 && deepActiveElement() == this.view.contentDOM)
...
export { EditorState, EditorView, basicSetup, esLint, javascript, javascriptLanguage, jsxLanguage, snippets, tsxLanguage, typescriptLanguage };
